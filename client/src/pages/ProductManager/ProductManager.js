...
const ProductManager = () => {
  ...
  const clickSubmit = () => {
    if (name === null) {
      toast.error("Name is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }

    if (author === null) {
      toast.error("Author is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }

    if (cost === null) {
      toast.error("Cost is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }

    if (amount === null) {
      toast.error("Amount is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }

    if (description === null) {
      toast.error("Description is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }

    if (category === null) {
      toast.error("Category is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }

    if (publisher === null) {
      toast.error("Publisher is required, Please enter a value ", {
        position: toast.POSITION.TOP_CENTER,
      });
    }
