        ...
        <div>
        {
            isOpen?
                ...
                <div style={{backgroundColor: "aliceblue", borderRadius:'10px', margin:'20px'}}>
                  <div key = {props._id} className="order-column"style={{padding: '10px', margin:'20px'}}>
                    ...
                    <h style={{marginLeft: '15px', fontSize:'16px'}}><strong>Total:</strong> {props.cost} USD</h>
                    ...
                    {props.bought_products.map((bitem, i) =>
                    {
                      return(
                        <div style={{marginTop:'5px'}}>
                          ...
                          <h><strong>Amount:</strong> {props.amounts[i]}</h>
                        </div>
                      );}
                    )}
                    </div>
